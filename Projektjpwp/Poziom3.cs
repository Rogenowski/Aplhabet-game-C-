...
namespace Projektjpwp
{
    public partial class Poziom3 : Form
    {
        ...
        System.Windows.Forms.Label[] tablica = new System.Windows.Forms.Label[7];
        public Poziom3()
        {
            InitializeComponent();
        ...
        public void sprawdz(Label a)
        {
            ...
            {
                stopWatch.Stop();
                wynik3 = string.Format("{0}:{1}.{2}", stopWatch.Elapsed.Minutes, stopWatch.Elapsed.Seconds, stopWatch.Elapsed.Milliseconds);
                System.Media.SoundPlayer myPlayer = new System.Media.SoundPlayer();
                myPlayer.SoundLocation = "win.wav";
                myPlayer.Play();
                MessageBox.Show("Wygrywasz, czas gry: " +wynik3, "Wygrana", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void Poziom3_Load_1(object sender, EventArgs e)
        {
            stopWatch = new Stopwatch();
            stopWatch.Start();
            Poziom1.losowanie(liczba, tablica);
        }
        private void Poziom3_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
    }
